...
> **你**：画一只猫咪
>
> **UMIBot**：`<qqimg>~/.openclaw/umibot/images/cute-cat.png</qqimg>`
...
> **你**：用语音讲个笑话
>
> **UMIBot**：`<qqvoice>~/.openclaw/umibot/tts/joke.silk</qqvoice>`
...
>
> **UMIBot**：`<qqfile>~/.openclaw/umibot/downloads/战争与和平_第一章.txt</qqfile>`
...
> **你**：发一个演示视频给我
>
> **UMIBot**：`<qqvideo>~/.openclaw/umibot/downloads/demo.mp4</qqvideo>`
