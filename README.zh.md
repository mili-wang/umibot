...
<img width="316" height="410" alt="Umi 群二维码" src="https://github.com/user-attachments/assets/d079ba89-ecd0-437f-9e66-92319801a325" />
...
> 富媒体能力（图片、语音、视频、文件）的完整说明请参阅 [富媒体指南](docs/umibot-media-guide.md)。
...
| 选项 | 说明 |
|------|------|
| `--appid <id>` | Umi 机器人 AppID |
| `--secret <secret>` | Umi 机器人 AppSecret |
| `--markdown <yes\|no>` | 是否启用 Markdown 消息格式（默认: no） |
| `-h, --help` | 显示帮助 |

也支持环境变量：`UmiBOT_APPID`、`UmiBOT_SECRET`、`UmiBOT_TOKEN`（AppID:Secret）。
...
- [富媒体指南](docs/umibot-media-guide.md) — 图片、语音、视频、文件
