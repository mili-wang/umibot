...
# 可能的扩展目录名（原仓库 umibot + 本仓库框架推断名 openclaw-umi）
EXTENSION_DIRS=("umibot" "openclaw-umi" "umibot")
...
cleanup_installation() {
  ...
  if [ -f "$CONFIG_FILE" ]; then
    ...
    node -e "
      ...
      const ids = ['umibot', 'openclaw-umi', '@sliverp/umibot', '@tencent-connect/umibot', '@tencent-connect/openclaw-umi', '@mili-wang/umibot', 'umibot'];
