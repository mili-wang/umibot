...
/**
 * Umi Bot CLI - 用于升级和管理 Umi Bot 插件
 * 
 * 用法:
   ...
   if (existsSync(configFile)) {
     try {
       ...
       if (config.channels?.umibot) {
         oldUmibotConfig = { ...config.channels.umibot };
