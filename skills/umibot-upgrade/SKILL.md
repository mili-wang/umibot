---
name: umibot-upgrade
description: 通过官方脚本将 openclaw-umibot 插件升级到最新 npm 版本。当用户要求更新 QQ 机器人插件、升级 umibot 扩展或同步官方最新版时使用。
metadata: {"openclaw":{"emoji":"⬆️","requires":{"config":["channels.umibot"]}}}
---
...
- 更新 / 升级 `openclaw-umibot` 或 UMIBot 插件
- 拉取官方最新 npm 包
...
- 脚本由 [tencent-connect/openclaw-umibot](https://github.com/tencent-connect/openclaw-umibot) 仓库 `main` 分支提供，通过 npm 完成升级流程（具体步骤以脚本为准）
